# Generated by Django 5.0.2 on 2024-04-03 01:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'maintence'), ('o', 'On loan'), ('a', 'Available'), ('r', 'Reerved')], default='m', help_text='Book availability', max_length=1)),
